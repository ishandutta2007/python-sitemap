...
parser.add_argument('--hreflang', action="store_true", default=False, required=False, help="Add hreflang alternate links to sitemap.xml, read from <link rel=\"alternate\" hreflang=\"...\"> tags (see https://developers.google.com/search/docs/specialty/international/localized-versions#sitemap)")
